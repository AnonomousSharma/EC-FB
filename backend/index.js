...
mongoose.connect("mongodb+srv://sharmaumesh6162:Umesh123@cluster0.gfda9.mongodb.net/sharmaumesh6162?retryWrites=true&w=majority&tls=true",{
...
app.get('/newcollections',async (req,res)=>{
    ...
    console.log("NewCollection Fetche");
    res.send(newcollection);
})



// /creatin endpoint for popular in women section
